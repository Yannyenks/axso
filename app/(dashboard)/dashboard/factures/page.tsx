  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-[20px] font-bold text-[#111111] tracking-tight">Factures</h1>
          <p className="text-[12.5px] text-[#AAAAAA] mt-0.5">Facturation automatique des commandes</p>
        </div>
