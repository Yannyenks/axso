  ...
  return (
    <div className="w-[300px] flex-shrink-0 bg-white border-l border-gray-200 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin p-3 space-y-4">
        {tab === "contenu" && !estConteneur && <ContentEditor config={node.config || {}} onChange={onChangeConfig} />}
...
function ContentEditor({ config, onChange }: { config: Record<string, any>; onChange: (patch: Record<string, any>) => void }) {
