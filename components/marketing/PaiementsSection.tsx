  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white relative overflow-hidden" id="paiements">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 -right-20 w-80 h-80 bg-[#1B2A4A]/5 rounded-full blur-3xl" style={{ animation: "aurora 12s ease-in-out infinite" }} />
        <div className="absolute bottom-10 -left-20 w-64 h-64 bg-[#F5A623]/8 rounded-full blur-3xl" style={{ animation: "aurora 9s ease-in-out 3s infinite" }} />
      </div>
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16 xl:px-24 relative">
        ...
        >
          <span className="text-[#1B2A4A] text-sm font-semibold uppercase tracking-widest mb-4 block">
            Paiements Africains
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            return (
              <div
                key={i}
                className="text-center p-6 bg-[#F5A623]/8 rounded-2xl border border-[#F5A623]/20 hover:scale-[1.04] hover:shadow-xl hover:shadow-[#1B2A4A]/15 transition-all duration-300"
                style={{
                  opacity: visible ? 1 : 0,
              ...
              >
                <div className="inline-flex items-center justify-center w-12 h-12 bg-white rounded-xl mb-4 shadow-sm group-hover:scale-110 transition-transform">
                  <Icone className="text-[#1B2A4A]" size={24} />
                </div>
