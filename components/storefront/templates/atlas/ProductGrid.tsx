...
function fallbackGradient(accent: string, secondaire: string, i: number): string {
  const angles = [`linear-gradient(160deg, ${accent}, #1B1B1E)`, `linear-gradient(160deg, ${secondaire}, #6c6c68)`, `linear-gradient(160deg, #2c2c30, #1B1B1E)`];
...
export function AtlasProductGrid({ produits, slug, devise, commissionRate, colors: c }: Props) {
