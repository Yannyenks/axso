...
export function AtlasProductPage({ tenant, cfg, slug, produit, prixAffiche, prixCompareAffiche, produitsSimilaires }: Props) {
  const c = cfg.colors;
      ...
      <section className="grid lg:grid-cols-[90px_1fr_1fr] gap-6" style={{ padding: "50px 4vw" }}>
        ...
        <div className="order-3 flex flex-col justify-center">
          ...
          <div className="flex items-baseline gap-3 mb-6">
            <span className="text-[19px] font-mono">{formatMontant(prixAffiche, devise)}</span>
