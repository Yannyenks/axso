  ...
  return (
    <div
      style={{
        ...
        border: "2px solid white", boxShadow: "0 2px 10px rgba(27,42,74,0.35)",
        flexShrink: 0,
      }}
    >
    ...
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <defs>
        <linearGradient id="gHome" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#3a5480"/>
...
export function IconMessages({ size = 32 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      {/* Lignes de texte */}
      <line x1="9" y1="15" x2="19" y2="15" stroke="#1B2A4A" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="9" y1="18.5" x2="15" y2="18.5" stroke="#1B2A4A" strokeWidth="1.5" strokeLinecap="round"/>
      {/* Bulle secondaire */}
    ...
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <defs>
        <linearGradient id="gAna" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="100%" stopColor="#12203d"/>
        </linearGradient>
      </defs>
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      <path d="M16 8 C11 8 7 11.5 7 16 C7 19 8.5 21.5 11 23 L11 26 H14 L14 24 H18 L18 26 H21 L21 23 C23.5 21.5 25 19 25 16 C25 11.5 21 8 16 8 Z"
        fill="white" opacity="0.85"/>
      <line x1="16" y1="8" x2="16" y2="13" stroke="#3a5480" strokeWidth="1.5"/>
      <line x1="11" y1="10" x2="14" y2="14" stroke="#3a5480" strokeWidth="1" opacity="0.6"/>
      <line x1="21" y1="10" x2="18" y2="14" stroke="#3a5480" strokeWidth="1" opacity="0.6"/>
      <circle cx="16" cy="16" r="2" fill="#3a5480" opacity="0.7"/>
      <rect width="32" height="14" rx="8" fill="white" opacity="0.07"/>
    </svg>
  );
}
...
export function IconThemes({ size = 32 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      <circle cx="16" cy="11" r="1.8" fill="#3a5480" opacity="0.7"/>
      <circle cx="20.5" cy="13.5" r="1.8" fill="#22c55e" opacity="0.7"/>
      <circle cx="20" cy="18" r="1.8" fill="#F5A623" opacity="0.7"/>
