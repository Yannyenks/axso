...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/pos",                     label: "Caisse POS",   Icone: IconPaiements },
      ...
      { href: "/dashboard/sourcing/import",         label: "Import CSV",   Icone: IconSourcing },
      { href: "/dashboard/transporteurs",           label: "Transporteurs",Icone: IconLivraisons },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/affiliation/materiel",   label: "Matériel Aff.",Icone: IconThemes },
